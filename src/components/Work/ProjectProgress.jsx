    ...
    <>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            <div style={{
                ...
                {code === "933251" && (<img src={tree_stage_1} alt="tree" style={{height: "20vw", marginTop: "52vw"}}/>)}
                {code === "933264" && (<img src={tree_stage_2} alt="tree" style={{height: "35vw", marginTop: "37vw"}}/>)}
                {code === "933255" && (<img src={tree_stage_3} alt="tree" style={{height: "50vw", marginTop: "22vw"}}/>)}
                {code === "902294" && (<img src={tree_stage_4} alt="tree" style={{height: "65vw", marginTop: "7vw"}}/>)}
                {code === "953277" && (<img src={tree_stage_3} alt="tree" style={{height: "50vw", marginTop: "22vw"}}/>)}
