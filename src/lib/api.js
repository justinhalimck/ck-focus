...
export async function subscribeUser() {
  ...
  const subscription = await reg.pushManager.subscribe({
    ...
    applicationServerKey: urlBase64ToUint8Array('BKF0WTy4EETAK1RyuX8um3sOTrasPFhNw1KA4vGh92ShxAE4abJJ8_xgDuWm_z57OilljFd2z2r3XQx5eBrWvEY')
  })

  // send subscription object to your backend for storage
  axios.post('https://pomodoro-api.incin.net/api/subscribe', {
